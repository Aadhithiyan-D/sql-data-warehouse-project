...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_crm\cust_info.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
...
---------- Loading  data for prd_info ------------------------------------------------------------------------------------
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_crm\prd_info.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
...
---------- Loading  data for sales_details ----------------------------------------------------------------------------------
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_crm\sales_details.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
...
------- Loading  data for CUST_AZ12 ------------------------------------------------------------------------------------------
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_erp\CUST_AZ12.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
...
------- Loading  data for LOC_A101 -----------------------------------------------------------------------------
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_erp\LOC_A101.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
...
------- Loading  data for LOC_A101 --------------------------------------------------------------------------------
		...
		FROM 'E:\D folder\SQL_Data_warehouse_Data_with_Bara\sql_data_warehouse\datasets\source_erp\PX_CAT_G1V2.csv'
		WITH ( 
			  FIRSTROW = 2,
			  FIELDTERMINATOR=',',
			  TABLOCK
